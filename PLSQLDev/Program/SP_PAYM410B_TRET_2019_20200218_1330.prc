CREATE OR REPLACE PROCEDURE SP_PAYM410B_TRET_2019
(
...
/*@@zodem*/
/*V_OCCR_LOC_NM := '법정기부금(10) 2013년 이월된 금액';
V_DB_ERROR_CTNT := 'CNTRIB1.CNTRIB_GIAMT:'||CNTRIB1.CNTRIB_GIAMT||chr(13)||chr(10)||
                   ...
                   'CNTRIB1.CNTRIB_PREAMT:'||CNTRIB1.CNTRIB_PREAMT||chr(13)||chr(10)||
                   'CNTRIB1.CNTRIB_GONGAMT:'||CNTRIB1.CNTRIB_GONGAMT||chr(13)||chr(10)
                   ;
SP_SSTM056_CREA(V_DB_PGM_ID, V_OCCR_LOC_NM, SQLCODE, V_DB_ERROR_CTNT, IN_INPT_ID , IN_INPT_IP ); */
...
/*@@zodem*/
/*V_OCCR_LOC_NM := '>법정기부금(10) 기부금(이월분)';
V_DB_ERROR_CTNT := 'CNTRIB1.CNTRIB_GIAMT:'||CNTRIB1.CNTRIB_GIAMT||chr(13)||chr(10)||
                   'V_LABOR_EARN_AMT:'||V_LABOR_EARN_AMT||chr(13)||chr(10)||
                   'V_CNTRIB_DUC_SUM_AMT10:'||V_CNTRIB_DUC_SUM_AMT10||chr(13)||chr(10)||
                   'V_CNTRIB_DUC_SUM_AMT20:'||V_CNTRIB_DUC_SUM_AMT20||chr(13)||chr(10)||
...
SP_SSTM056_CREA(V_DB_PGM_ID, V_OCCR_LOC_NM, SQLCODE, V_DB_ERROR_CTNT, IN_INPT_ID , IN_INPT_IP ); */
                         ...
                         IF (CNTRIB1.CNTRIB_YY = '2013' AND CNTRIB1.CNTRIB_YY = IN_YY - 10 ) THEN    --2013년 법정기부금 10년전에 발생하여 이월된 법정기부금은 소멸.
                                                                                                      --@VER.2019_5 이월공제기간 10년으로 연장(IN_YY - 5에서 IN_YY -10으로 수정)
                                                                                                      --2023년도 최종 소멸

                            --V_OCCR_LOC_NM := '법정기부금(10) 2014년이후 5년전 발생 이월분[소멸]'; 2018년 이전 주석처리된 내용이므로 2019년부터 내용 수정 하지 않음.
                            ...
                            IF CNTRIB1.CNTRIB_OVERAMT > V_LABOR_EARN_AMT - V_CNTRIB_DUC_SUM_AMT10 - V_CNTRIB_DUC_SUM_AMT20 THEN --전체 누적이 아닌 법정 기부금 누적금액만 계산
                               V_CNTRIB_DUC_AMT     := V_LABOR_EARN_AMT - V_CNTRIB_DUC_SUM_AMT10 - V_CNTRIB_DUC_SUM_AMT20;
                               V_CNTRIB_PREAMT      := CNTRIB1.CNTRIB_PREAMT + CNTRIB1.CNTRIB_GONGAMT; -- 기부금 전년까지 공제금액
                               V_CNTRIB_GONGAMT     := V_CNTRIB_DUC_AMT;                                 -- 기부금 당년 공제금액
                               V_CNTRIB_DESTAMT     := CNTRIB1.CNTRIB_OVERAMT - V_CNTRIB_DUC_AMT;        -- 기부금 당년 소멸금액
                               V_CNTRIB_OVERAMT     := 0 ;       -- 기부금 당년 이월금액
                            ELSE
                               V_CNTRIB_DUC_AMT     := CNTRIB1.CNTRIB_OVERAMT;
                               V_CNTRIB_PREAMT      := CNTRIB1.CNTRIB_PREAMT + CNTRIB1.CNTRIB_GONGAMT; -- 기부금 전년까지 공제금액
...
/*@@zodem*/
/*V_OCCR_LOC_NM := '법정기부금(10) 2014년이후 10년이내 이월된 금액';
V_DB_ERROR_CTNT := 'CNTRIB1.CNTRIB_GIAMT:'||CNTRIB1.CNTRIB_GIAMT||chr(13)||chr(10)||
                   'V_LABOR_EARN_AMT:'||V_LABOR_EARN_AMT||chr(13)||chr(10)||
                   'V_CNTRIB_DUC_SUM_AMT10:'||V_CNTRIB_DUC_SUM_AMT10||chr(13)||chr(10)||
                   'V_CNTRIB_DUC_SUM_AMT20:'||V_CNTRIB_DUC_SUM_AMT20||chr(13)||chr(10)||
...
/*@@zodem*/
/*V_OCCR_LOC_NM := '>법정기부금(10) 기부금(이월분) 2014년보다 큰 경우';
V_DB_ERROR_CTNT := 'CNTRIB1.CNTRIB_GIAMT:'||CNTRIB1.CNTRIB_GIAMT||chr(13)||chr(10)||
                   'V_LABOR_EARN_AMT:'||V_LABOR_EARN_AMT||chr(13)||chr(10)||
                   'V_CNTRIB_DUC_SUM_AMT10:'||V_CNTRIB_DUC_SUM_AMT10||chr(13)||chr(10)||
                   'V_CNTRIB_DUC_SUM_AMT20:'||V_CNTRIB_DUC_SUM_AMT20||chr(13)||chr(10)||
...
SP_SSTM056_CREA(V_DB_PGM_ID, V_OCCR_LOC_NM, SQLCODE, V_DB_ERROR_CTNT, IN_INPT_ID , IN_INPT_IP ); */
                         ...
                         IF (CNTRIB1.CNTRIB_YY >= '2014' AND CNTRIB1.CNTRIB_YY = IN_YY - 10 ) THEN    --2014년이후 법정기부금 5년전에 발생하여 이월된 법정기부금은 소멸
                                                                                                      --@VER.2019_5 이월공제기간 10년으로 연장(IN_YY - 5에서 IN_YY -10으로 수정)
                            ...
                            /*@VER.2015 ZODEM 2016.02.17 2014년이후 기부금부터 세액공제액 */
                            IF CNTRIB1.CNTRIB_YY >= '2014' THEN
                               V_FLAW_CNTRIB_DUC_OBJ_AMT := V_FLAW_CNTRIB_DUC_OBJ_AMT + V_CNTRIB_DUC_AMT; -- 법정기부금공제대상금액
                            END IF;
