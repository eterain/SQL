...
/***************************************************************************************
객 체 명 : SP_PAYM410B_2019_DONATE_SAVE
내    용 : 연말정산 기부금저장처리
작 성 일 : 2020.01.31.
작 성 자 : 박용주
수정내역
...
BEGIN
    ...
    BEGIN                
        ...
        IF ( IN_SETT_FG = 'A031300003' ) THEN  --연말정산 시뮬레이션인 경우
            ...
            ;            
            INSERT INTO PAYM436( BIZR_DEPT_CD,YY,SETT_FG,RPST_PERS_NO     --대표개인번호
                                ,CNTRIB_YY         --기부년도
        ...
        ELSE
            DELETE FROM PAYM432 
             WHERE YY = IN_YY
               ...
               AND CNTRIB_TYPE_CD = IN_CNTRIB_TYPE_CD
            ;      
            INSERT INTO PAYM432( BIZR_DEPT_CD,YY,SETT_FG,RPST_PERS_NO     --대표개인번호
                                ,CNTRIB_YY         --기부년도
                                ,CNTRIB_TYPE_CD   --기부금유형
                                ,CNTRIB_GIAMT     --기부금액
                                ,CNTRIB_PREAMT     --전년까지 공제금액
