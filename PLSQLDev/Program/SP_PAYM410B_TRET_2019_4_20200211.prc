                          ...
                          ELSE
                             ...
                             /* ②금액이 0이하일 경우 ①금액(V_TMP10_AMT) 공제 : 2014년이후 이월 법정기부금(년도순) */
                              ...
                              UPDATE PAYM436
                                ...
                                SET CNTRIB_GONGAMT = CASE WHEN V_TMP10_AMT_2014 - (CNTRIB_GIAMT - CNTRIB_PREAMT) <= 0 THEN V_TMP10_AMT_2014
                                    ELSE V_TMP10_AMT_2014 - (CNTRIB_GIAMT - CNTRIB_PREAMT) - V_TMP10_AMT_2014 END


                                   , CNTRIB_OVERAMT = CASE WHEN REC_10_IWOL_2014.CNTRIB_YY = IN_YY - 10
                                                           THEN 0
                                                           ELSE (CNTRIB_GIAMT - CNTRIB_PREAMT) - V_TMP10_AMT_2014
                                                      END
                                   , CNTRIB_DESTAMT = CASE WHEN REC_10_IWOL_2014.CNTRIB_YY = IN_YY - 10
                                                           THEN (CNTRIB_GIAMT - CNTRIB_PREAMT) - V_TMP10_AMT_2014
                                                           ELSE 0
                      ...
                      BEGIN
                       ...
                       ELSE
                        ...
                        /* 기부금 공제 순서 변경. 2014년 이후 이월금액으로 처리 @2019_7*/
                          ...
                          UPDATE PAYM436
                             SET CNTRIB_GONGAMT = V_TMP10_AMT_2014
                               , CNTRIB_OVERAMT = CNTRIB_GIAMT - V_TMP10_AMT_2014
                           WHERE YY             = IN_YY
                             AND CNTRIB_YY      = IN_YY /*당해 기부금 */
                             AND SETT_FG        = V_SETT_FG
                             AND BIZR_DEPT_CD   = IN_BIZR_DEPT_CD
...
DBMS_OUTPUT.PUT_LINE('----- eterain M 최초금액 V_FLAW_CNTRIB_DUC_OBJ_AMT : ' || V_FLAW_CNTRIB_DUC_OBJ_AMT );            
...
DBMS_OUTPUT.PUT_LINE('----- eterain M LOOP : ' || V_TMP10_AMT_2014 );
...
DBMS_OUTPUT.PUT_LINE('----- eterain M LOOP : ' || REC_10_IWOL_2014.CNTRIB_YY );
DBMS_OUTPUT.PUT_LINE('----- eterain M 최초금액 V_TMP10_AMT_2014 : ' || V_TMP10_AMT_2014 );
...
DBMS_OUTPUT.PUT_LINE('----- eterain M (1) V_TMP_AMT_ETE : ' || V_TMP_AMT_ETE );

DBMS_OUTPUT.PUT_LINE('----- eterain M (1) V_TMP10_AMT_2014 : ' || V_TMP10_AMT_2014 );
DBMS_OUTPUT.PUT_LINE('----- eterain M SELECT 계산 V_TMP10_AMT_2014 : ' || V_TMP10_AMT_2014 );

                          /*  ②금액이 0보다 클 경우 기부액 전액 공제 : 2014년이후 이월 법정기부금(년도순) */
                          IF V_TMP10_AMT_2014 > 0 THEN

DBMS_OUTPUT.PUT_LINE('----- eterain M (2) V_TMP10_AMT_2014 > 0 : ' || V_TMP10_AMT_2014 );
DBMS_OUTPUT.PUT_LINE('----- eterain M (2) V_TMP_AMT > 0 : ' || V_TMP_AMT );
                              ...
                              SELECT CNTRIB_GIAMT - CNTRIB_PREAMT
                               ...
                               WHERE YY             = IN_YY
                                ...
                                --eterain2 V_TMP_AMT := V_TMP_AMT - V_TMP10_AMT_2014;
                                --eterain2 V_TMP10_AMT_2014 := V_TMP_AMT;
                                
                          ELSE
                              
DBMS_OUTPUT.PUT_LINE('----- eterain M (3) V_TMP10_AMT_2014 < 0 : ' || V_TMP10_AMT_2014 );
DBMS_OUTPUT.PUT_LINE('----- eterain M (3) V_TMP_AMT < 0 : ' || V_TMP_AMT );
...
DBMS_OUTPUT.PUT_LINE('----- eterain M (4) V_TMP10_AMT_2014 SELECT : ' || V_TMP10_AMT_2014 );
...
DBMS_OUTPUT.PUT_LINE('----- eterain M (9) V_TMP_AMT END LOOP : ' || V_TMP_AMT );
DBMS_OUTPUT.PUT_LINE('----- eterain M (9) V_TMP10_AMT_2014 END LOOP : ' || V_TMP10_AMT_2014 );
DBMS_OUTPUT.PUT_LINE('----- eterain M (9) V_TMP_AMT_ETE END LOOP : ' || V_TMP_AMT_ETE );
...
--eterain2
DBMS_OUTPUT.PUT_LINE('----- eterain M (10) V_TMP_AMT := V_TMP10_AMT_2014 : ' || V_TMP10_AMT_2014 );
DBMS_OUTPUT.PUT_LINE('----- eterain M (10) V_TMP_AMT := V_TMP_AMT : ' || V_TMP_AMT );
DBMS_OUTPUT.PUT_LINE('----- eterain M (10) V_TMP_AMT := V_TMP_AMT_ETE : ' || V_TMP_AMT_ETE );
                          IF  V_TMP_AMT > 0 THEN 
                              ...
                              V_TMP10_AMT_2014 := 0;                          
                          END IF;
DBMS_OUTPUT.PUT_LINE('----- eterain M (10) V_TMP_AMT := V_TMP_AMT + V_TMP10_AMT_2014 : ' || V_TMP_AMT );
--eterain2                
...
--eterain2   
--                   
DBMS_OUTPUT.PUT_LINE('----- eterain M (11) V_TMP10_AMT > 0 UPDATE GIAMT   GONGAMT : ' || V_TMP_AMT );
...
DBMS_OUTPUT.PUT_LINE('----- eterain M (11) V_TMP10_AMT else UPDATE GONGAMT : ' || V_TMP_AMT );
                    ...
                    /* ①금액이 0이하일 경우 법정기부공제대상금액 공제 :당해 법정기부금 */
                      ...
                      UPDATE PAYM432
                         ...
                         --eterain2 SET CNTRIB_GONGAMT = CASE WHEN (CNTRIB_GIAMT - V_TMP10_AMT_2014) < 0 THEN (V_TMP10_AMT_2014 - CNTRIB_GIAMT) 
                         --eterain2                           ELSE (CNTRIB_GIAMT - V_TMP10_AMT_2014) END 
                         --eterain2   , CNTRIB_OVERAMT = V_TMP10_AMT_2014
                         SET CNTRIB_GONGAMT = V_TMP_AMT
...
--eterain3            
    DBMS_OUTPUT.PUT_LINE('----- eterain M - INSERT : ' || V_FLAW_CNTRIB_DUC_OBJ_AMT );            
--eterain3    
